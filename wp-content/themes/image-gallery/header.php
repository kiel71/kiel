...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'image-gallery' ); ?></a>
	<?php if (esc_attr(get_theme_mod( 'social_media_activate_header' ))) { image_gallery_social_section (); } ?>
